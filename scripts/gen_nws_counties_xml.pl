...
sub process_statelist {
    ...
    open STATE, ">", "app/src/main/res/values/states.xml";
    print STATE <<EOF1;
...
EOF3
    close STATE;
    print "Wrote app/src/main/res/values/states.xml.\n";
}
...
open COUNTIES, ">", "app/src/main/res/values/counties.xml";
print COUNTIES <<EOF1;
<?xml version="1.0" encoding="utf-8"?>
<!-- This file is generated by scripts/gen_nws_counties_xml.pl -->
<resources>
...
EOF3
close COUNTIES;
print "Wrote app/src/main/res/values/counties.xml\n";
